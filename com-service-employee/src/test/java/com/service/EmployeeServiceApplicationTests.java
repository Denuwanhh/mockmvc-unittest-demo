...
public class EmployeeServiceApplicationTests {
	...
	public void Employee_WhenPost_ShouldGetID() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/employees").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
				.content(new ObjectMapper().writeValueAsString(employee))).andExpect(status().isCreated())
	...
	public void Employee_WhenPostWithoutName_ShouldNotAllow() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/employees").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
				.content(new ObjectMapper().writeValueAsString(employee))).andExpect(status().isBadRequest())
	...
	public void Employee_WhenPutWithEmployeeID_ShouldRecordUpdate() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.put("/employees/1").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	public void Employee_WhenPutWithEmployeeIDNotExisting_ShouldGetNotFoundStatus() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.put("/employees/-10").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	@Test
	public void Employee_WhenDeleteWithNotExistingEmployeeID_ShouldGetNotFound() throws Exception {
		mockMvc.perform(
				MockMvcRequestBuilders.delete("/employees/10").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
